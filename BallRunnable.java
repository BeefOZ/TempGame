...
class BallRunnable implements Runnable, GameConstants {
    ...
    class MousePlayer extends MouseAdapter {
        ...
        public void mousePressed(MouseEvent e) {
            ...
            Ball ball = new Ball(e.getX(), e.getY(), 0, 0, BASERADIUS,
                    new Color(random.nextInt(255), random.nextInt(255), random.nextInt(255)), 1, 1);
        ...
        while (true) {
            try {
                ...
                for (int i = 0; i < ballQnt; i++) {
                    ...
                    Ball ball = new Ball(randomX.nextInt(DEFAULT_WIDTH), randomY.nextInt(DEFAULT_HEIGHT),
                            randomX.nextInt(2) + 1, randomY.nextInt(2) + 1, BASERADIUS,
                            new Color(randomX.nextInt(255), randomX.nextInt(255), randomX.nextInt(255)), 0, 0);
                    ballComponent.addBall(ball);
                }
                ...
                while (countInWork != 0) {
                    ...
                    for (Ball ball : ballComponent.listBall) {
                        ...
                        if (ballComponent.startClick) {
                            ...
                            EventQueue.invokeLater(new Runnable() {
                                public void run() {
                                    scoreLabel.setText("Уровень: " + level + ", Вы выбили " + ballComponent.score
                                            + " из " + ballQnt);
                                }
                            });
                        }
            ...
            if (ballComponent.score < goal) {
                ...
                JOptionPane.showMessageDialog(ballComponent, "Цель уровня не достигнута. \nНабрано очков: "
